...
'database.redis.horizon.database','database.redis.horizon.options.prefix','elasticsearch.host','elasticsearch.enabled','filesystems.default',
...
'filesystems.disks.s3.report','filesystems.links./var/www/public/storage','horizon.domain','horizon.path','horizon.use',
...
'horizon.environments.production.supervisor-1.connection','horizon.environments.production.supervisor-1.queue','horizon.environments.production.supervisor-1.maxProcesses','horizon.environments.production.supervisor-1.balanceMaxShift','horizon.environments.production.supervisor-1.balanceCooldown',
...
'horizon.environments.local.supervisor-1.tries','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths',
...
'files.index','files.store','files.destroy','home','articles.show',
'articles.similar','articles.aggregation.cities','chat.index','chat.send',
...
'app','mail.test-mail','horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
